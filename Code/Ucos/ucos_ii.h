...
#ifdef OS_TIME_CHAIN
OS_EXT OS_TIMECHAIN *OSTimeChainFreeList;
OS_EXT OS_TIMECHAIN *OSTimeChainList;
OS_EXT OS_TIMECHAIN OSTimeChainTbl[OS_MAX_TASKS + OS_N_SYS_TASKS];
#endif
